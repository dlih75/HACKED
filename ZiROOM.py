...
\n\x1b[1;33mAUTHOR:ZIRO
\n\x1b[1;33mMY TELEGRAM@XZIRO12
\n\x1b[1;33mMY CHANALE:@kurdkurd1234

\033[33mtkaya gar edit dakayt ba nawman la gal bet
\033[33mgar edit dakayt ba pyawana bika w maifrosha
"""
print("___________X_ZIRO_________________")
back = 0
successful = []
cpb = []
oks = []
...
def menu():
    ...
    print logo
    print 42 * '\x1b[1;33m-'
    print '[1]Crack number kurdistan '
    print '[2] crack number iran' 
    print '[0]BACK           '
    print ' '
    print 42 * '\x1b[1;33m-'
    action()
